...
class TambalBanOrderDetail extends Component {
  state = {
    checked: false,
    setChecked: false,
    liter: "",
          ...
          <div style={styles.subBody}>
            ...
            <div id="identitas" style={styles.pesanan}>
              ...
              <div style={styles.identitasInput}>
                <div style={styles.identitasFrame}>
                  {" "}
                  <p style={{ fontSize: "13px" }}>Tipe Ban</p>
                  <select style={styles.input}>
                    <option>Tubeless</option>
                    <option disabled>Non Tubeless (Segera Hadir) </option>
                  </select>
                </div>
              </div>
            </div>
...
export default withRouter(TambalBanOrderDetail);
